...
export class MyTangram extends CGFobject {
    ...
    initMaterials() {
            ...
            this.tangramMaterial.setAmbient(0.1, 0.1, 0.1, 1.0);
            this.tangramMaterial.setDiffuse(0.9, 0.9, 0.9, 1.0);
    ...
    display(){
        ...
        this.triangleSmall.setTexCoords(0);
        this.tangramMaterial.apply();
        ...
        this.triangleSmall.setTexCoords(1);
        this.tangramMaterial.apply();
        this.triangleSmall.display();
        this.scene.popMatrix();
        ...
        this.scene.rotate((Math.PI/4), 0, 0, 1);
        this.triangleBig.setTexCoords(0); 
        this.tangramMaterial.apply();
        ...
        this.triangleBig.setTexCoords(1);
        this.tangramMaterial.apply(); 
        this.triangleBig.display();
        this.scene.popMatrix();
