...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.globalAmbientBrightness = 0.3;
        this.initCameras();
        this.initLights();
        this.initMaterials();
    ...
    initLights() {
        this.setGlobalAmbientLight(this.globalAmbientBrightness, this.globalAmbientBrightness, this.globalAmbientBrightness, 1.0);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.6, 0.3, 0.2, 1.0);
        this.material4.setDiffuse(0.1, 0.1, 0.1, 1.0);
        this.material4.setSpecular(0.1, 0, 0, 1.0);
